...
extern "C++" K3D_CORE_API void EnumAllDeviceAdapter(rhi::IDeviceAdapter** &, uint32*);
...
public:
	...
	rhi::ShaderResourceViewRef NewShaderResourceView(rhi::GpuResourceRef, const rhi::ResourceViewDesc &) override;
...
class SyncPointFence : public rhi::ISyncFence, public D3D12RHIDeviceChild
{
	friend class Device;
public:
	SyncPointFence(Device::Ptr pDevice = nullptr) : D3D12RHIDeviceChild(pDevice)
	{
...
public:
	...
	void CopyBuffer(rhi::IGpuResource& Dest, rhi::IGpuResource& Src, rhi::CopyBufferRegion const& Regions) override;
	...
	void ClearColorBuffer(rhi::GpuResourceRef, kMath::Vec4f const & color)override;
	...
	*/
	...
	void TransitionResourceBarrier(rhi::GpuResourceRef resource, rhi::EResourceState dstState) override;
