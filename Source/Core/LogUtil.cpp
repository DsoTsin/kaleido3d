...
namespace k3d {
	...
	bool Log::InitLogFile(const char *name)
	{
		...
		OutputStr2IODevice(g_LogFile, "\n\t<link rel=\"stylesheet\" href=\"http://112.74.110.22/config/style.style\">\n</head>");
		OutputStr2IODevice(g_LogFile, "\n<body>\n\t<nav id=\"nav\" class=\"nav\">\n\t\t<div class=\"alignleft\">\n\t\t\t");
		OutputStr2IODevice(g_LogFile, "<a href=\"./\" class=\"logo\"><img src=\"http://112.74.110.22/config//logo.png\" alt=\"TsinStudio\"></a>\n\t\t");
