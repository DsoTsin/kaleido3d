...
#undef STR
	...
	VkShaderModule loadShaderGLSL(const char *fileName, VkDevice device, VkShaderStageFlagBits stage)
	{
		...
		return loadShaderGLSLFromSource(device, shaderCode, stage);
	}

	VkShaderModule loadShaderGLSLFromSource(VkDevice device, const char *shaderCode, VkShaderStageFlagBits stage) {
