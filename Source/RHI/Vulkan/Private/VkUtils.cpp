...
RenderTarget::RenderTarget(Device::Ptr pDevice, Texture::TextureRef texture, SpFramebuffer framebuffer, VkRenderPass renderpass)
	: DeviceChild(pDevice)
...
Texture::TextureRef RenderTarget::GetTexture() const
{
