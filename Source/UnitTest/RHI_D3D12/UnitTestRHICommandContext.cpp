...
void UnitTestRHICommandContext::InitPipeLineState()
{
	...
	*/
	...
	m_TestPipelineState->SetRenderTargetFormat(rhi::RenderTargetFormat());
	...
	m_TestPipelineState->SetPrimitiveTopology(rhi::EPT_Triangles);
...
{
	rhi::ICommandContext * GfxContext = (m_TestCommandContext);
